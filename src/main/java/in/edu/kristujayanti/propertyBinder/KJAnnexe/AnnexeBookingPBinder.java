...
public enum AnnexeBookingPBinder implements KJUSYSPropertyBinder {
    ...
    START_DATE_OF_PROGRAMME("startDateOfProgramme_KJAnnexeBooking_Long", "Start Date of Programme", Long.class),
    END_DATE_OF_PROGRAMME("endDateOfProgramme_KJAnnexeBooking_Long", "End Date of Programme", Long.class),
    CHECK_IN_DATE("checkInDate_KJAnnexeBooking_Long", "Check-in Date", Long.class),
    CHECK_OUT_DATE("checkOutDate_KJAnnexeBooking_Long", "Check-out Date", Long.class),
    ...
    BED_INFO("bedIds_KJAnnexeBooking_Array", "Bed Information", Document.class),
